        ...
        try:
            ...
            for img_path in sample_images:
                ...
                try:
                    ...
                    print(f"  Image dimensions: {image_data.size}, Color mode: {image_data.mode}")
                    ...
                    print(f"  Classification: Class {predicted_class}, "
...
def demo_real_time_processing():
    ...
    try:
        ...
        for frame_idx in range(num_frames):
            ...
            color = ['lightblue', 'lightgreen', 'lightcoral', 'lightyellow'][frame_idx % 4]
        ...
        if fps >= target_fps:
            ...
            print(f"   Recommended: Use faster model or better hardware")
...
def demo_multi_model_comparison():
    ...
    if results:
        ...
        print(f"{'Model':<25} {'Load Time':<10} {'Latency':<10} {'Throughput':<12} {'Device'}")
        print("-" * 75)
        ...
        print(f"🏆 Fastest Loading: {best_load['model']} ({best_load['load_time']:.2f}s)")
