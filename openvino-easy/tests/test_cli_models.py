...
from oe.cli import (
    model_search, model_info, model_install, 
    model_validate, model_benchmark
)
...
class TestCLIModelValidate:
    ...
    def test_validate_specific_model(self, mock_validate):
        ...
        mock_validate.return_value = {
            ...
            'passed': 1, 
            'failed': 0,
            'models': [{'name': 'specific_model', 'valid': True, 'errors': [], 'warnings': []}]
        }
...
class TestCLIModelBenchmark:
    ...
    def test_benchmark_with_failures(self, mock_benchmark, capsys):
        ...
        mock_benchmark.return_value = {
            ...
            'summary': {
                'fastest_model': {'id': 'test/good_model', 'fps': 25.0, 'device': 'CPU'},
                'slowest_model': {'id': 'test/good_model', 'fps': 25.0, 'device': 'CPU'},
                'average_fps': 25.0
            }
        }
