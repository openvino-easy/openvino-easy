...
class TestCrossPlatform:
    ...
    @pytest.mark.skipif(platform.system() == "Darwin", reason="Intel drivers not available on macOS")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for unicode_name in unicode_names:
                try:
                    ...
                    print(f"⚠️  Unicode path '{unicode_name}' not supported on this system: {e}")
    ...
    def test_memory_usage_cross_platform(self):
        ...
        assert memory_increase < 100, f"Memory leak detected: {memory_increase:.1f} MB not released"
...
class TestWindowsSpecific:
    ...
    def test_windows_path_length_limits(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            long_path_parts = ["very_long_directory_name_that_exceeds_normal_limits"] * 10
            long_path = temp_path
